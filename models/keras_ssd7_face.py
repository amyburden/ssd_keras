...
def build_model(image_size,
    ...
    # 48
    conv2 = Conv2D(64, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal',
    ...
    # 64
    conv4 = Conv2D(128, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal',
                   kernel_regularizer=l2(l2_reg), name='conv4')(pool3)
    conv4 = BatchNormalization(axis=3, momentum=0.99, name='bn4')(conv4)
    conv4 = LeakyReLU(0.125)(conv4)
    pool4 = MaxPooling2D(pool_size=(2, 2), name='pool4')(conv4)
    # 48
    conv5 = Conv2D(96, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal',
                   kernel_regularizer=l2(l2_reg), name='conv5')(pool4)
    conv5 = BatchNormalization(axis=3, momentum=0.99, name='bn5')(conv5)
    conv5 = LeakyReLU(0.125)(conv5)
    pool5 = MaxPooling2D(pool_size=(2, 2), name='pool5')(conv5)
    # 48
    conv6 = Conv2D(64, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal',
                   kernel_regularizer=l2(l2_reg), name='conv6')(pool5)
    conv6 = BatchNormalization(axis=3, momentum=0.99, name='bn6')(conv6)
    conv6 = LeakyReLU(0.125)(conv6)
    pool6 = MaxPooling2D(pool_size=(2, 2), name='pool6')(conv6)
    # 32
    conv7 = Conv2D(48, (3, 3), strides=(1, 1), padding="same", kernel_initializer='he_normal',
