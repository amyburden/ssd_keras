...
def ssd_mn_300(image_size,
    ...
    # 10
    conv14_1 = Conv2D(256, (1, 1), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv6_1')(conv13)
    ...
    conv14_2 = Conv2D(512, (3, 3), strides=(2, 2), activation='relu', padding='valid', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv6_2')(conv14_1)
    conv14_2 = BatchNormalization(epsilon=2e-5, name='bn14_2')(conv14_2)
    conv14_2 = Activation('relu')(conv14_2)
    # 5
    conv15_1 = Conv2D(128, (1, 1), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv7_1')(conv14_2)
    ...
    conv15_2 = Conv2D(256, (3, 3), strides=(2, 2), activation='relu', padding='valid', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv7_2')(conv15_1)
    conv15_2 = BatchNormalization(epsilon=2e-5, name='bn15_2')(conv15_2)
    conv15_2 = Activation('relu')(conv15_2)
    # 3
    conv16_1 = Conv2D(128, (1, 1), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv8_1')(conv15_2)
    ...
    conv16_2 = Conv2D(256, (3, 3), strides=(1, 1), activation='relu', padding='valid', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv8_2')(conv16_1)
    conv16_2 = BatchNormalization(epsilon=2e-5, name='bn16_2')(conv16_2)
    conv16_2 = Activation('relu')(conv16_2)
    # 2
    conv17_1 = Conv2D(128, (1, 1), activation='relu', padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv9_1')(conv16_2)
    conv17_1 = BatchNormalization(epsilon=2e-5, name='bn16_1')(conv17_1)
    conv17_1 = Activation('relu')(conv17_1)
    conv17_1 = ZeroPadding2D(padding=((1, 1), (1, 1)), name='conv27_padding')(conv17_1)
    conv17_2 = Conv2D(256, (3, 3), strides=(1, 1), activation='relu', padding='valid', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv9_2')(conv17_1)
    conv17_2 = BatchNormalization(epsilon=2e-5, name='bn16_1')(conv17_2)
